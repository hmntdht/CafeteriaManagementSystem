...
--
-- Host: 127.0.0.1    Database: cms_database
-- ------------------------------------------------------
...
CREATE TABLE `MenuItem` (
  ...
  CONSTRAINT `menuitem_ibfk_1` FOREIGN KEY (`categoryID`) REFERENCES `Category` (`categoryID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `OrderItem` (
  ...
  CONSTRAINT `orderitem_ibfk_2` FOREIGN KEY (`itemID`) REFERENCES `MenuItem` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-06-24 16:09:41
